    ...
    <section className="px-2 py-10 md:px-0 bg-[#F0F8FF]">
      <figure className="mx-auto max-w-2xl">
        ...
        <blockquote className="mt-10 text-xl text-gray-900">
          <p>
            “Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cum perspiciatis quam nulla,
            rerum provident dicta ipsum officiis nobis dolore neque commodi praesentium placeat
            earum assumenda.”
          </p>
        </blockquote>
